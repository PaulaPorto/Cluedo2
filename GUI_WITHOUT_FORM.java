...
/**
 * GUI class that handles the components on the window that is displayed
...
public abstract class GUI {
    ...
    private final ImageIcon rollDiceImage = new ImageIcon("rollDice.png");
    ...
    public void setCurrentPlayerAndCharacterPanel(JLabel character, JLabel playerName, JLabel characterName){
        if(Game.currentCharacter.equalsIgnoreCase("Miss Scarlett")){
            character.setIcon(new ImageIcon("Characters_Scarlet.png"));
        }
        else if(Game.currentCharacter.equalsIgnoreCase("Col. Mustard")){
            character.setIcon(new ImageIcon("Characters_Mustard.png"));
        }
        else if(Game.currentCharacter.equalsIgnoreCase("Mrs. White")){
            character.setIcon(new ImageIcon("Characters_White.png"));
        }
        else if(Game.currentCharacter.equalsIgnoreCase("Mr. Green")){
            character.setIcon(new ImageIcon("Characters_Green.png"));
        }
        else if(Game.currentCharacter.equalsIgnoreCase("Mrs. Peacock")){
            character.setIcon(new ImageIcon("Characters_Peacock.png"));
        }
        else if(Game.currentCharacter.equalsIgnoreCase("Prof. Plum")){
            character.setIcon(new ImageIcon("Characters_Plum.png"));
        }
    ...
    private void initialise() {
        ...
        //Creating the constraints for the bottom Panel
        ...
        //Character is going to be placed on the right side of the window in a rectangle
        ...
        //Panel for the top panel where the board will be placed
        ...
        //Panel for the dark background at the back at the top behind the board and character displayed
        ...
        //Drawing pane, making the drawing canvas overriding the paintComponent method to draw
        ...
        this.drawingPane.addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent e) {
                try{
                    ...
                    if(Game.movesDone == Game.diceValue){
                        throw new Exception();
                    }
                    doMove();
                    if(Game.invalidMove){
                    ...
                    JDialog invalid = new JDialog();
                    JLabel noMoreMove = new JLabel("You cannot move anymore");
                    invalid.setLayout(new FlowLayout());
                    invalid.add(noMoreMove);
                    invalid.pack();
        ...
        this.confirmButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    if(Game.totalNamesAndCharacters % 2 != 0 || Game.totalPlaying < 3){
                        throw new Exception();
                    }
                    ...
                    JDialog noPlayers = new JDialog();
                    JLabel error = new JLabel("Error!!!");
                    noPlayers.setLayout(new FlowLayout());
                    noPlayers.add(error);
                    noPlayers.pack();
                    noPlayers.setLocationRelativeTo(null);
        ...
        rollDiceButton.setToolTipText("Click to roll the dice");   //hover effect for dice roll button

        JButton suggestButton = new JButton("Suggest");
        suggestButton.setToolTipText("Click to make a suggestion");   //hover effect suggestion button

        JButton accuseButton = new JButton("Accuse");
        accuseButton.setToolTipText("Click to make an accusation");   //hover effect accusation button

        JButton endTurnButton = new JButton("End Turn");
        endTurnButton.setToolTipText("Click to let the next player make a move");   //hover effect turn button
